...
//        });
        ...
        getEtPhone().setOnFocusChangeListener((v, hasFocus) -> mPresenter.changeHasFocusViewBackgroundColor(v));

        getEtPwd().setOnFocusChangeListener((v, hasFocus) -> mPresenter.changeHasFocusViewBackgroundColor(v));

        mBtnLogin.setOnClickListener(v -> mPresenter.login(getEtPhone().getText().toString().trim(), getEtPwd().getText().toString().trim()));
    }
